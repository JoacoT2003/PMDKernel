"""Wrapper de `pytorch_lightning.Trainer.fit` para v2_1_pinn (MSE-only).

EarlyStopping + ModelCheckpoint + CometLogger. Sin physics losses no hay
necesidad de `manual_clip_val` ni gradient balancing — el flow es Lightning
estándar.
...
def train(lit_model, loader_tr, loader_va, *,
    ...
    logger.experiment.add_tags(["v2_1_pinn", "mse_only"])
